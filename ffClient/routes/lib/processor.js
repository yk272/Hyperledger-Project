...
function createProduct(familyName,inputList,outputList,Privkey,payload,familyVersion = '1.0'){
    const privateKeyHex = Privkey  
    console.log("priv",privateKeyHex);
    ...
    sendProduct(batchListBytes);	
  }
  
  /*
  function to submit the batchListBytes to validator
  */
  async function sendProduct(batchListBytes){
